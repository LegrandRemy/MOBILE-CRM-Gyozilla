...
const Header = () => {
    ...
    return (
        <>
        { user ? 
            <Box style={{ flexDirection:"row", justifyContent: "space-between", alignItems:"center", width: '100%', height:70, backgroundColor:"#1d292b"}}>
                <Image marginTop={5} source={require("../../../assets/logo_gyozilla.png")} alt='Logo' style={{marginLeft: 10, width:"25%", height:100}}/>
